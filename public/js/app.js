...
/* harmony default export */ __webpack_exports__["a"] = ({
    ...
    initialize: function initialize(cookie) {
        if (cookie) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__helpers_api__ = __webpack_require__(13);
//
//
//
//
...
/* harmony default export */ __webpack_exports__["a"] = ({
    created: function created() {
        __WEBPACK_IMPORTED_MODULE_0__store_auth__["a" /* default */].initialize(this.$cookie.get('authentication'));
        this.$cookie.delete('authentication');
        if (__WEBPACK_IMPORTED_MODULE_0__store_auth__["a" /* default */].state.redirect) {
            this.$router.push(__WEBPACK_IMPORTED_MODULE_0__store_auth__["a" /* default */].state.redirect);
        }
    },
    ...
    methods: {
        resendEmail: function resendEmail() {
            var app = this;
            app.divload = true;
            this.$http.get('auth/resendEmail').then(function (response) {
                app.divload = false;
            }, function (response) {});
        }
    } // end of method
...
/* harmony default export */ __webpack_exports__["a"] = ({
    ...
    methods: {
        getUserDetails: function getUserDetails(transition) {
            this.$auth.get('/users/' + this.$route.params.name).then(function (response) {
...
/* harmony default export */ __webpack_exports__["a"] = ({
    ...
    methods: {
        getInfo_basic: function getInfo_basic() {
            var _this = this;

            var app = this;
            this.divload = true;
            this.$http.get('/users_infos/' + this.$auth.user().slug_name).then(function (response) {
                if (response.data.data.length === 0) {
                    _this.getWork();
                    // alert();
                } else {
                    _this.divBasic = false;
                    _this.divHome = true;
                }
            }, function (response) {});
        },
        getWork: function getWork() {
            ...
            var app = this;
            this.$http.get('/works/' + this.$auth.user().slug_name).then(function (response) {
                if (response.data.data.length === 0) {
                    _this2.divInfo = true;
                    _this2.divHome = false;
                    _this2.getIndustry();
                } else {
                    _this2.divInfo = false;
                    _this2.getIndustry();
                    //this.getInfo_basic();
                    _this2.divBasic = true;
                }
        ...
        getIndustry: function getIndustry() {
            ...
            var app = this;
            this.$http.get('/industries').then(function (response) {
                _this3.industries = response.data.data;
            }, function (response) {});
        },
        SaveWork: function SaveWork() {
            ...
            var app = this;
            app.divload = true;
            this.$http.post('/work/', this.work).then(function (response) {
                app.divload = false;
                M.toast({ html: 'Work Experience Successfully added.', classes: 'rounded green' });
                _this4.getWork();
                _this4.getInfo_basic();
            }, function (response) {});
        },
        SaveInfo: function SaveInfo() {
            ...
            var app = this;
            app.divload = true;
            this.$http.post('/users_info', this.user_info).then(function (response) {
                app.divload = false;
                _this5.getInfo_basic();
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__store_auth__ = __webpack_require__(4);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__helpers_api__ = __webpack_require__(13);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__helpers_status__ = __webpack_require__(56);
//
//
//
//
...
/* harmony default export */ __webpack_exports__["a"] = ({
    created: function created() {
        if (__WEBPACK_IMPORTED_MODULE_0__store_auth__["a" /* default */].state.error) {
            this.error = __WEBPACK_IMPORTED_MODULE_0__store_auth__["a" /* default */].state.error.includes('+') ? __WEBPACK_IMPORTED_MODULE_0__store_auth__["a" /* default */].state.error.replace(/\+/gi, ' ') : __WEBPACK_IMPORTED_MODULE_0__store_auth__["a" /* default */].state.error;
        }
    },
    data: function data() {
        return {
    ...
    methods: {
        ...
        socialLogin: function socialLogin() {
            var app = this;
            app.divload = true;
            this.$http.get('/auth/facebook').then(function (response) {
...
/* harmony default export */ __webpack_exports__["a"] = ({
    ...
    methods: {
        SaveInfo: function SaveInfo() {
            ...
            var app = this;
            app.divload = true;
            this.$http.put('/users_info/' + this.user_info.info_id, this.user_info).then(function (response) {
                app.divload = false;
                $('#modProfile').modal('close');
                _this.showInfo_basic();
                M.toast({ html: 'Data Successfully saved.', classes: 'rounded blue' });
            }, function (response) {});
        },

        editInfoModal: function editInfoModal() {
            $('.modal').modal({ dismissible: false });
            $('#modProfile').modal('open');
        ...
        getInfo: function getInfo() {
            ...
            var app = this;
            this.$http.get('/users_infos/' + this.$route.params.slug).then(function (response) {
                _this2.user_info.info_id = response.data.data[0].id;
                _this2.user_info.headline = response.data.data[0].headline;
                _this2.user_info.position = response.data.data[0].position_id;
                _this2.user_info.educ_id = response.data.data[0].educ_id;
                _this2.user_info.loc_id = response.data.data[0].loc_id;
                _this2.user_info.lastname = response.data.data[0].lastname;
                _this2.user_info.name = response.data.data[0].name;
                _this2.user_info.zipcode = response.data.data[0].zipcode;
                _this2.user_info.tel_no = response.data.data[0].tel_no;
                _this2.user_info.industry_id = response.data.data[0].industry_id;
                _this2.user_info.medialink = response.data.data[0].medialink;
            }, function (response) {});
        },
        showInfo_basic: function showInfo_basic() {
            var _this3 = this;

            var app = this;
            this.$http.get('/users_infos/' + this.$route.params.slug).then(function (response) {
                _this3.show_info.headline = response.data.data[0].headline;
                _this3.show_info.lastname = response.data.data[0].lastname;
                _this3.show_info.name = response.data.data[0].name;
                _this3.show_info.medialink = "//www.youtube.com/embed/" + response.data.data[0].medialink + "?rel=0";
                _this3.show_info.position = response.data.data[0].position;
                _this3.show_info.company = response.data.data[0].company;
            }, function (response) {});
        },
        getIndustry: function getIndustry() {
            var _this4 = this;
        ...
        getWork: function getWork() {
            ...
            var app = this;
            this.$http.get('/works/' + this.$route.params.slug).then(function (response) {
                if (response.data.data.length === 0) {
                    _this5.divWork = true;
                } else {
                    _this5.divWork = false;
                }
                _this5.works = response.data.data;
            }, function (response) {});
        },
        getEducations: function getEducations() {
            ...
            var app = this;
            this.$http.get('/educations/' + this.$route.params.slug).then(function (response) {
                if (response.data.data.length === 0) {
                    _this6.divEduc = true;
                } else {
                    _this6.divEduc = false;
                }
                _this6.educations = response.data.data;
            }, function (response) {});
        },

        showModalWork: function showModalWork(event) {
            if (event === "add") {
                $('.modal').modal({ dismissible: false });
                $('#modExpi').modal('open');
                this.getIndustry();
                ...
                this.getIndustry();
                this.edit = true;
                this.work.work_id = event.work_id;
                this.work.title = event.title;
                this.work.company = event.company;
                this.work.location = event.location;
                this.work.from_year = event.from_year;
                this.work.from_month = event.from_month;
                this.work.to_month = event.to_month;
                this.work.to_year = event.to_year;
                this.work.industry = event.industry;
                this.work.description = event.description;
            }
        },
        showModalEduc: function showModalEduc(event) {
            if (event === "add") {
                $('.modal').modal({ dismissible: false });
                $('#modEduc').modal('open');
                this.edit = false;
                ...
                this.education.educ_id = event.educ_id;
                this.education.school_name = event.school_name;
                this.education.degree = event.degree;
                this.education.field_of_study = event.field_of_study;
                this.education.from_year = event.from_year;
                this.education.to_year = event.to_year;
                this.education.description = event.description;
            }
        },
        deleteWork: function deleteWork(id) {
            ...
            var app = this;
            app.divload = true;
            this.$http.delete('/work/' + id).then(function (response) {
                app.divload = false;
                $('#modExpi').modal('close');
                M.toast({ html: 'Work Experience deleted.', classes: 'rounded red' });
                _this7.getWork();
            }, function (response) {});
        },
        deleteEduc: function deleteEduc(id) {
            var _this8 = this;

            var app = this;
            app.divload = true;
            this.$http.delete('/education/' + id).then(function (response) {
                app.divload = false;
                $('#modEduc').modal('close');
                M.toast({ html: 'Education Experience deleted.', classes: 'rounded red' });
                _this8.getEducations();
            }, function (response) {});
        },
        SaveWork: function SaveWork() {
            var _this9 = this;
            ...
            if (this.edit === false) {
                ...
                this.$http.put('/work/' + this.work.work_id, this.work).then(function (response) {
                    app.divload = false;
                    $('#modExpi').modal('close');
                    M.toast({ html: 'Work Experience Successfully saved.', classes: 'rounded blue' });
                    _this9.getWork();
                }, function (response) {});
            }
        },
        SaveEduc: function SaveEduc() {
            var _this10 = this;
            ...
            if (this.edit === false) {
                ...
                this.$http.post('/education/', this.education).then(function (response) {
                    app.divload = false;
                    $('#modEduc').modal('close');
                    M.toast({ html: 'Education Successfully added.', classes: 'rounded green' });
                    _this10.getEducations();
                }, function (response) {});
            } else {

                this.$http.put('/education/' + this.education.educ_id, this.education).then(function (response) {
                    app.divload = false;
                    $('#modEduc').modal('close');
                    M.toast({ html: 'Education Successfully saved.', classes: 'rounded blue' });
                    _this10.getEducations();
                }, function (response) {});
            }
        },
        getPosition: function getPosition() {
            var app = this;
            this.$http.get('/users_infos').then(function (response) {}, function (response) {});
        }
    }
});
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_vue_axios__ = __webpack_require__(44);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_vue_cookie__ = __webpack_require__(45);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__App_vue__ = __webpack_require__(47);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__components_Dashboard_vue__ = __webpack_require__(49);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__components_Home_vue__ = __webpack_require__(51);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__components_Register_vue__ = __webpack_require__(53);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__components_Login_vue__ = __webpack_require__(55);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__components_Profile_vue__ = __webpack_require__(58);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__components_Messages_vue__ = __webpack_require__(60);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__components_Error_vue__ = __webpack_require__(62);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__components_Job_Post_vue__ = __webpack_require__(64);
var _Vue$use;
...
var router = new __WEBPACK_IMPORTED_MODULE_1_vue_router__["a" /* default */]({
    routes: [{
        ...
        path: '/register',
        name: 'register',
        component: __WEBPACK_IMPORTED_MODULE_8__components_Register_vue__["a" /* default */],
        meta: {
        ...
        path: '/404',
        name: 'error',
        redirect: __WEBPACK_IMPORTED_MODULE_12__components_Error_vue__["a" /* default */],
        meta: {
            auth: false
        }
    }, {
        path: '/login',
        name: 'login',
        component: __WEBPACK_IMPORTED_MODULE_9__components_Login_vue__["a" /* default */],
        meta: {
        ...
        path: '/vc/:slug',
        name: 'profile',
        component: __WEBPACK_IMPORTED_MODULE_10__components_Profile_vue__["a" /* default */],
        meta: {
        ...
        path: '/messages',
        name: 'messages',
        component: __WEBPACK_IMPORTED_MODULE_11__components_Messages_vue__["a" /* default */],
        meta: {
        ...
        path: '/job-post',
        name: 'job-posting',
        component: __WEBPACK_IMPORTED_MODULE_13__components_Job_Post_vue__["a" /* default */],
        meta: {
...
__WEBPACK_IMPORTED_MODULE_0_vue___default.a.use(__webpack_require__(66), (_Vue$use = {
    auth: {
...
}, _defineProperty(_Vue$use, 'auth', __webpack_require__(70)), _defineProperty(_Vue$use, 'http', __webpack_require__(71)), _defineProperty(_Vue$use, 'router', __webpack_require__(72)), _defineProperty(_Vue$use, 'rolesVar', 'role'), _defineProperty(_Vue$use, 'tokenName', 'jwt_auth_token'), _defineProperty(_Vue$use, 'facebookOauth2Data', {
...
__WEBPACK_IMPORTED_MODULE_0_vue___default.a.component('navbar', __webpack_require__(73));
__WEBPACK_IMPORTED_MODULE_0_vue___default.a.component('sidebar', __webpack_require__(75));
...
var app = new __WEBPACK_IMPORTED_MODULE_0_vue___default.a({
    el: '#app',
    components: { Login: __WEBPACK_IMPORTED_MODULE_9__components_Login_vue__["a" /* default */] },
    router: router,
    render: function render(app) {
        return app(__WEBPACK_IMPORTED_MODULE_5__App_vue__["a" /* default */]);
    }
});
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_6dd1125c_hasScoped_false_optionsId_0_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_App_vue__ = __webpack_require__(48);
...
var Component = Object(__WEBPACK_IMPORTED_MODULE_2__node_modules_vue_loader_lib_runtime_component_normalizer__["a" /* default */])(
  ...
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_6dd1125c_hasScoped_false_optionsId_0_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_App_vue__["a" /* render */],
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_6dd1125c_hasScoped_false_optionsId_0_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_App_vue__["b" /* staticRenderFns */],
...
var render = function() {
  ...
  return _c("div", { staticClass: "container-fluid" }, [
    _c(
      ...
      {
        staticClass:
          "navbar navbar-expand-lg  navbar-dark  bg-dark nav-less fixed-top"
      },
      [
        _vm._m(0),
        _vm._v(" "),
          ...
          ? _c(
              ...
              [
                _c("ul", { staticClass: "navbar-nav mr-auto" }, [
                  _c(
                    "li",
                    { staticClass: "nav-item active logo-con" },
                    [
                      _c("router-link", {
              ...
              [
                _c("ul", { staticClass: "navbar-nav mr-auto" }, [
                  _vm.$auth.check()
                    ? _c(
                        "li",
                        { staticClass: "nav-item menu-pad" },
                        [
                          _c(
                            "router-link",
                            {
                              staticClass: "nav-link mr-md-2",
                              attrs: { to: { name: "home" } }
                            },
                            [
                              _c("span", [
                              ...
                              _vm._v(" "),
                              _c("span", { staticClass: "menu-block" }, [
                                _vm._v(" Home")
                              ])
                            ]
                          )
        ...
        _c(
          ...
          [
            _vm.$auth.check()
              ? _c("li", { staticClass: "nav-item dropdown user-line" }, [
                  _vm._m(2),
                  _vm._v(" "),
                  _c(
                    "div",
                      ...
                      _c(
                        "router-link",
                        {
                          ...
                          attrs: {
                            to: {
                              name: "profile",
                              params: { slug: _vm.$auth.user().slug_name }
                            }
                          }
                        },
                        [_vm._v(" View Profile")]
    ...
    _vm._v(" "),
    _vm.$auth.ready() ? _c("div", {}, [_c("router-view")], 1) : _vm._e(),
    _vm._v(" "),
    !_vm.$auth.ready()
      ? _c("div", { staticClass: "container" }, [_vm._m(3)])
      : _vm._e(),
    _vm._v(" "),
    _vm.divload
      ? _c("div", { staticClass: "preloader-background" }, [_vm._m(4)])
      : _vm._e(),
    _vm._v(" "),
    _c("div", { staticClass: "hide-on-large-only" }, [
      _c("footer", [
        _c(
          "ul",
          { staticClass: "nav-main nav-container display-flex full-height" },
          [
            _c(
              "li",
              {
                staticClass: "nav-item nav-item--feed nav-item__link--underline"
              },
              [
                _c(
                  "router-link",
                  {
                    staticClass: "nav-item__link  js-nav-item-link active ",
                    attrs: { to: { name: "home" } }
                  },
                  [
                    _c("span", { staticClass: "nav-item__icon" }, [
                      _c("i", { staticClass: "fa fa-home" })
                    ]),
                    _vm._v(" "),
                    _c("span", { staticClass: "nav-item__title" }, [
                      _vm._v(" Home")
                    ])
                  ]
                )
            ...
            _c(
              "li",
              { staticClass: "nav-item nav-item--feed" },
              [
                _c(
                  "router-link",
                  {
                    staticClass:
                      " nav-item__link nav-item__link--underline js-nav-item-link  ",
                    attrs: { to: { name: "messages" } }
                  },
                  [
                    _c("span", { staticClass: "nav-item__icon" }, [
...
var staticRenderFns = [
  function() {
    ...
    var _h = _vm.$createElement
    var _c = _vm._self._c || _h
    return _c("div", { staticClass: "logo-con" }, [
      _c("button", { staticClass: "logo-btn" }, [_c("b", [_vm._v("V")])])
    ])
  },
  function() {
    var _vm = this
    ...
    return _c("ul", { staticClass: "navbar-nav mr-auto" }, [
      _c("input", {
        staticClass: "form-control text-search",
  ...
  function() {
    ...
    return _c(
      "a",
      {
        staticClass: "nav-item nav-link dropdown-toggle mr-md-2",
        attrs: {
          href: "#",
          id: "bd-versions",
      ...
      [
        _c("span", [_c("i", { staticClass: "fa fa-user-circle" })]),
        _vm._v(" "),
        _c("span", { staticClass: "menu-block" }, [_vm._v(" Me")])
      ]
    )
  },
  function() {
    ...
    var _h = _vm.$createElement
    var _c = _vm._self._c || _h
    return _c("div", { staticClass: "preloader-background" }, [
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_78b73b2d_hasScoped_false_optionsId_0_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_Dashboard_vue__ = __webpack_require__(50);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__node_modules_vue_loader_lib_runtime_component_normalizer__ = __webpack_require__(1);
var disposed = false
/* script */
...
var Component = Object(__WEBPACK_IMPORTED_MODULE_2__node_modules_vue_loader_lib_runtime_component_normalizer__["a" /* default */])(
  ...
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_78b73b2d_hasScoped_false_optionsId_0_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_Dashboard_vue__["a" /* render */],
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_78b73b2d_hasScoped_false_optionsId_0_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_Dashboard_vue__["b" /* staticRenderFns */],
  __vue_template_functional__,
  __vue_styles__,
  __vue_scopeId__,
  __vue_module_identifier__
...
var render = function() {
  ...
  return _vm.$auth.ready()
    ? _c("div", { staticClass: "container" }, [
        _vm.$auth.user().verified == 0
          ? _c("div", { staticClass: "verified-banner" }, [
              _vm._v(
                "\n           You're account is not still verified! Click the link to send verifications.\n           "
              ),
              _c(
                "a",
                { staticClass: "btn waves-effect btn-small white blue-text" },
                [_vm._v("SEND VERIFICATIONS")]
              )
            ])
          : _vm._e(),
        _vm._v(" "),
            ...
            _c("div", { staticClass: "card small" }, [
              ...
              _c("div", { staticClass: "card-content" }, [
                _c(
                  ...
                  {
                    staticClass:
                      "card-title activator grey-text text-darken-4 text-center"
                  },
                  [
                    _vm._v(
                      _vm._s(_vm.$auth.user().name) +
                ...
                _c(
                  "p",
                  { staticClass: "grey-text text-darken-4 text-center" },
                  [_vm._v("78")]
                ),
                _vm._v(" "),
                _vm._m(2),
...
var staticRenderFns = [
    ...
    return _c(
      ...
      [
        _c("img", {
          ...
          attrs: { src: "https://materializecss.com/images/sample-1.jpg" }
        })
      ]
    )
  },
  function() {
    ...
    var _h = _vm.$createElement
    var _c = _vm._self._c || _h
    return _c("p", { staticClass: "text-center mb-1" }, [
  ...
  function() {
    ...
    var _h = _vm.$createElement
    var _c = _vm._self._c || _h
    return _c("p", { staticClass: " grey-text text-darken-1 text-center" }, [
      _c("span", [_c("i", { staticClass: "fa fa-link" })]),
      _vm._v(" Networks")
    ])
  },
  function() {
  ...
  function() {
    ...
    return _c("div", {}, [
      _c("div", { staticClass: "collection" }, [
        ...
        _c(
          "a",
          { staticClass: "collection-item active", attrs: { href: "#!" } },
  ...
  function() {
    ...
    return _c("div", { staticClass: "col-6" }, [
        ...
        _c("form", {}, [
          _c("div", { staticClass: "row" }, [
            _c("div", { staticClass: "input-field col s12" }, [
              _c("div", { staticClass: "form-group input-field" }, [
                _c("label", { attrs: { for: "post" } }, [
                  _vm._v("Post a job, ideas and feeds")
                ]),
                _vm._v(" "),
                _c("input", {
                  staticClass: "form-control",
                  attrs: { type: "text", name: "post", required: "" }
                })
              ]),
              _vm._v(" "),
              _c(
                ...
                {
                  staticClass:
                    "btn waves-effect waves-light white btn-small black-text",
              ...
              _c(
                ...
                {
                  staticClass:
                    "btn waves-effect waves-light light-blue darken-4 btn-small pull-right",
                  attrs: { type: "submit", name: "action" }
                },
                [
                  _vm._v(
      ...
      _vm._v(" "),
      _c("div", { staticClass: "feed-option" }, [
        _c("small", { staticClass: "grey-text" }, [_vm._v("My feed")])
      ]),
      _vm._v(" "),
      _c("div", { staticClass: "card" }, [
        _c("div", { staticClass: "post-pane" }, [
          _c("div", { staticClass: "post" }, [
            _c("div", { staticClass: "user-block" }, [
              _c("img", {
                staticClass: "circle img-bordered-sm",
                attrs: {
                  src:
            ...
            _c("span", { staticClass: "pull-left" }, [
              _c(
                "a",
                {
                  staticClass: "link-black text-sm post-btn",
                  attrs: { href: "#" }
                },
                [
                  _c("i", { staticClass: "fa fa-share margin-r-15" }),
                  _vm._v(" Share")
                ]
              ),
              _vm._v(" "),
              _c(
                ...
                [
                  _c("i", { staticClass: "fa fa-thumbs-o-up margin-r-5" }),
                  _vm._v(" Like")
                ]
              )
            ]),
  ...
  function() {
    ...
    return _c("div", { staticClass: "col-3" }, [
      _c("div", { staticClass: "collection" }, [
        _c("p", { staticClass: "collection-item active" }, [
        ...
        _c("a", { staticClass: "collection-item", attrs: { href: "#!" } }, [
          ...
          _c("br"),
          _vm._v(" "),
          _c("small", [_vm._v("Basic description")])
        ]),
        _vm._v(" "),
        _c("a", { staticClass: "collection-item ", attrs: { href: "#!" } }, [
          _c("i", { staticClass: "fa fa-building" }),
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-78b73b2d", { render: render, staticRenderFns: staticRenderFns })
  }
}
...
/* unused harmony namespace reexport */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_85ef4954_hasScoped_false_optionsId_0_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_Home_vue__ = __webpack_require__(52);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__node_modules_vue_loader_lib_runtime_component_normalizer__ = __webpack_require__(1);
var disposed = false
/* script */
...
var Component = Object(__WEBPACK_IMPORTED_MODULE_2__node_modules_vue_loader_lib_runtime_component_normalizer__["a" /* default */])(
  ...
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_85ef4954_hasScoped_false_optionsId_0_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_Home_vue__["a" /* render */],
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_85ef4954_hasScoped_false_optionsId_0_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_Home_vue__["b" /* staticRenderFns */],
  __vue_template_functional__,
  __vue_styles__,
  __vue_scopeId__,
  __vue_module_identifier__
        ...
        _vm.divHome
          ? _c("div", { staticClass: "row" }, [
              _c("div", { staticClass: " col l12" }, [
                _vm.$auth.user().verified == 0
                  ? _c("div", { staticClass: "verified-banner bg-red" }, [
                      _vm._v(
                        "\n                   You're account is not still verified! Click the link to send verifications.\n                   "
                      ),
                      _c(
                        ...
                        {
                          staticClass:
                            "btn waves-effect btn-small white blue-text",
                          on: {
                            click: function($event) {
                              $event.preventDefault()
                              _vm.resendEmail()
              ...
              _vm._v(" "),
              _c("div", { staticClass: "col s3  hide-on-med-and-down" }, [
                _c("div", { staticClass: "card small" }, [
                  _vm._m(0),
                  _vm._v(" "),
                  _c("div", { staticClass: "card-content" }, [
                    _c(
                      ...
                      {
                        staticClass:
                          "card-title  grey-text text-darken-4 text-center"
                      },
                      [
                        _c(
                          "router-link",
              ...
              _vm._v(" "),
              _c("div", { staticClass: "col s12 l6 m12 " }, [
                  ...
                  _c("form", {}, [
                    _c("div", { staticClass: "row" }, [
                      _c("div", { staticClass: "input-field col s12" }, [
                        ...
                        _c(
                          "div",
                          { staticClass: "float-right wall-btn-div" },
                          [
                            _c(
                              "router-link",
                              {
                            ...
                            _c(
                              ...
                              {
                                staticClass:
                                  "btn waves-effect waves-light light-blue darken-4 btn-small text-right",
                                attrs: {
                                  disabled: "",
                                  type: "submit",
                                  name: "action"
                      ...
                      _c("div", { staticClass: "col l12" }, [
                        _c("div", { staticClass: "form-group" }, [
                          ...
                          _c("input", {
                            ...
                            domProps: { value: _vm.work.title },
                            on: {
                              input: function($event) {
                                if ($event.target.composing) {
                                  return
                                }
                                _vm.$set(_vm.work, "title", $event.target.value)
                              }
                            }
                          })
                        ])
                      ...
                      _c("div", { staticClass: "col l12" }, [
                        _c("div", { staticClass: "form-group" }, [
                          ...
                          _c("input", {
                            directives: [
                              {
                                name: "model",
                                rawName: "v-model",
                                value: _vm.work.company,
                                expression: "work.company"
                              }
                            ],
                            staticClass: "form-control custom-input",
                            attrs: {
                            ...
                            domProps: { value: _vm.work.company },
                            on: {
                              input: function($event) {
                                if ($event.target.composing) {
                                  return
                      ...
                      _c("div", { staticClass: "col l12" }, [
                        _c("div", { staticClass: "form-group" }, [
                          ...
                          _c("input", {
                            directives: [
                              {
                                name: "model",
                                rawName: "v-model",
                                value: _vm.work.location,
                                expression: "work.location"
                              }
                            ],
                            staticClass: "form-control custom-input",
                            attrs: {
                            ...
                            domProps: { value: _vm.work.location },
                            on: {
                              input: function($event) {
                                if ($event.target.composing) {
                                  return
                              ...
                              directives: [
                                {
                                  name: "model",
                                  rawName: "v-model",
                                  value: _vm.work.from_month,
                                  expression: "work.from_month"
                                }
                              ],
                              staticClass: "form-control custom-input",
                              attrs: { name: "from_month", required: "" },
                              on: {
                              ...
                              directives: [
                                {
                                  name: "model",
                                  rawName: "v-model",
                                  value: _vm.work.from_year,
                                  expression: "work.from_year"
                                }
                              ],
                              staticClass: "form-control custom-input",
                              attrs: { name: "from_year", required: "" },
                              on: {
                                change: function($event) {
                                  var $$selectedVal = Array.prototype.filter
                                    .call($event.target.options, function(o) {
                              ...
                              directives: [
                                {
                                  name: "model",
                                  rawName: "v-model",
                                  value: _vm.work.to_month,
                                  expression: "work.to_month"
                                }
                              ],
                              staticClass: "form-control custom-input",
                              attrs: { name: "to_month", required: "" },
                              on: {
                                change: function($event) {
                                  var $$selectedVal = Array.prototype.filter
                                    .call($event.target.options, function(o) {
                              ...
                              directives: [
                                {
                                  name: "model",
                                  rawName: "v-model",
                                  value: _vm.work.to_year,
                                  expression: "work.to_year"
                                }
                              ],
                              staticClass: "form-control custom-input",
                              attrs: { name: "to_year", required: "" },
                              on: {
                                change: function($event) {
                                  var $$selectedVal = Array.prototype.filter
                                    .call($event.target.options, function(o) {
                              ...
                              directives: [
                                {
                                  name: "model",
                                  rawName: "v-model",
                                  value: _vm.work.industry,
                                  expression: "work.industry"
                                }
                              ],
                              staticClass: "form-control custom-input",
                              attrs: { name: "industry", required: "" },
                              on: {
                                change: function($event) {
                                  var $$selectedVal = Array.prototype.filter
                                    .call($event.target.options, function(o) {
                            ...
                            [
                              ...
                              _vm._l(_vm.industries, function(industry) {
                                return _c(
                                  ...
                                  {
                                    key: industry.ind_id,
                                    domProps: { value: industry.ind_id }
                                  },
                                  [
                                    _vm._v(
                                      "\n                                           " +
                                        _vm._s(industry.ind_name) +
                                        "\n                                       "
                                    )
                                  ]
                                )
                      ...
                      _c("div", { staticClass: "col l12" }, [
                        _c("div", { staticClass: "form-group" }, [
                          ...
                          _c("textarea", {
                            ...
                            staticClass: "form-control",
                            attrs: { name: "description", id: "", rows: "5" },
                    ...
                    [
                      _c("div", {}, [
                        _c("div", { staticClass: "row" }, [
                          _c("div", { staticClass: "col l12" }, [
                            _c("div", { staticClass: "form-group" }, [
                              _c("label", { attrs: { for: "headline" } }, [
                                _vm._v("Basic headline")
                              ]),
                              _vm._v(" "),
                              _c("textarea", {
                                directives: [
                                  {
                                    name: "model",
                                    rawName: "v-model",
                                    value: _vm.user_info.headline,
                                    expression: "user_info.headline"
                                  }
                                ],
                                staticClass: "form-control",
                                attrs: { name: "headline", id: "", rows: "5" },
                                domProps: { value: _vm.user_info.headline },
                                on: {
                                  input: function($event) {
                                    if ($event.target.composing) {
                                      return
                                  ...
                                  directives: [
                                    {
                                      name: "model",
                                      rawName: "v-model",
                                      value: _vm.user_info.position,
                                      expression: "user_info.position"
                                    }
                                  ],
                                  staticClass: "form-control custom-input",
                                ...
                                directives: [
                                  {
                                    name: "model",
                                    rawName: "v-model",
                                    value: _vm.user_info.loc_id,
                                    expression: "user_info.loc_id"
                                  }
                                ],
                                staticClass: "form-control custom-input",
                                attrs: { type: "text" },
                                domProps: { value: _vm.user_info.loc_id },
                                on: {
                                  input: function($event) {
                                    if ($event.target.composing) {
                                      return
                          ...
                          _c("div", { staticClass: "col l6" }, [
                            _c("div", { staticClass: "form-group" }, [
                              ...
                              _c("input", {
                                directives: [
                                  {
                                    name: "model",
                                    rawName: "v-model",
                                    value: _vm.user_info.zipcode,
                                    expression: "user_info.zipcode"
                                  }
                                ],
                                staticClass: "form-control custom-input",
                                attrs: {
                                ...
                                domProps: { value: _vm.user_info.zipcode },
                                on: {
                                  input: function($event) {
                                    if ($event.target.composing) {
                                      return
                                  ...
                                  directives: [
                                    {
                                      name: "model",
                                      rawName: "v-model",
                                      value: _vm.user_info.industry_id,
                                      expression: "user_info.industry_id"
                                    }
                                  ],
                                  staticClass: "form-control custom-input",
                                  attrs: { name: "industry", required: "" },
                          ...
                          _c("div", { staticClass: "col l12" }, [
                            _c("div", { staticClass: "form-group" }, [
                              ...
                              _c("input", {
                                directives: [
                                  {
                                    name: "model",
                                    rawName: "v-model",
                                    value: _vm.user_info.tel_no,
                                    expression: "user_info.tel_no"
                                  }
                                ],
                                staticClass: "form-control custom-input",
                                attrs: {
                                ...
                                domProps: { value: _vm.user_info.tel_no },
                                on: {
                                  input: function($event) {
                                    if ($event.target.composing) {
                                      return
                          ...
                          _c("div", { staticClass: "col l12" }, [
                            _c("div", { staticClass: "form-group" }, [
                              _c("label", { attrs: { for: "media" } }, [
                                _vm._v("Youtube profile link ")
                              ]),
                              _vm._v(" "),
                              _c("img", {
                                attrs: { src: "img/youtube.PNG", alt: "" }
                              }),
                              _vm._v(" "),
                              _c("input", {
                                directives: [
                                  {
                                    name: "model",
                                    rawName: "v-model",
                                    value: _vm.user_info.medialink,
                                    expression: "user_info.medialink"
                                  }
                                ],
                                staticClass: "form-control custom-input",
                                attrs: {
                                ...
                                domProps: { value: _vm.user_info.medialink },
                                on: {
                                  input: function($event) {
                                    if ($event.target.composing) {
                                      return
...
var staticRenderFns = [
  ...
  function() {
    ...
    var _h = _vm.$createElement
    var _c = _vm._self._c || _h
    return _c("div", { staticClass: "form-group input-field wall-textbox" }, [
      _c("label", { attrs: { for: "post" } }, [
        _vm._v("Post a ideas or feeds")
      ]),
      _vm._v(" "),
      _c("input", {
        staticClass: "form-control ",
        attrs: { type: "text", name: "post" }
      })
    ])
  },
  function() {
    ...
    return _c(
      "button",
      {
        staticClass: "btn waves-effect waves-light white btn-small black-text",
        attrs: { type: "submit", name: "action" }
      },
      [
        _c("i", { staticClass: "fa fa-comment" }),
  ...
  function() {
    ...
    var _h = _vm.$createElement
    var _c = _vm._self._c || _h
    return _c("div", { staticClass: "feed-option" }, [
      _c("small", { staticClass: "grey-text" }, [_vm._v("My feed")])
    ])
  },
  function() {
  ...
  function() {
    ...
    var _h = _vm.$createElement
    var _c = _vm._self._c || _h
    return _c("div", { staticClass: "col s3 hide-on-med-and-down" }, [
      _c("div", { staticClass: "collection" }, [
        _c("p", { staticClass: "collection-item active" }, [
          _vm._v("Available Jobs")
        ]),
  ...
  function() {
    ...
    var _h = _vm.$createElement
    var _c = _vm._self._c || _h
    return _c("div", { staticClass: "col l12" }, [
      _c("br"),
      _vm._v(" "),
      _c("span", { staticClass: "info-title" }, [
        _vm._v(" Please input your current work informations")
      ])
    ])
  },
  function() {
    ...
    return _c("div", { staticClass: "col l12" }, [
      _c("label", [
        _c("input", { staticClass: "filled-in", attrs: { type: "checkbox" } }),
        _vm._v(" "),
        _c("span", [_vm._v("Present Work")])
      ])
    ])
  },
  function() {
    ...
    var _h = _vm.$createElement
    var _c = _vm._self._c || _h
    return _c("div", { staticClass: "col l12 form-group" }, [
      _c(
        "button",
        {
          staticClass:
            "waves-effect waves-green btn-flat blue white-text  float-right btn-block",
          attrs: { type: "submit" }
        },
        [_vm._v("Save work information")]
      )
    ])
  },
  function() {
    ...
    return _c("div", { staticClass: "col l12" }, [
      ...
      _vm._v(" "),
      _c("span", { staticClass: "info-title" }, [
        _vm._v(" Please update your basic informations")
      ])
    ])
  },
  function() {
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-85ef4954", { render: render, staticRenderFns: staticRenderFns })
  }
}
...
/* unused harmony namespace reexport */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_e24368cc_hasScoped_false_optionsId_0_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_Register_vue__ = __webpack_require__(54);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__node_modules_vue_loader_lib_runtime_component_normalizer__ = __webpack_require__(1);
var disposed = false
/* script */
...
var Component = Object(__WEBPACK_IMPORTED_MODULE_2__node_modules_vue_loader_lib_runtime_component_normalizer__["a" /* default */])(
  ...
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_e24368cc_hasScoped_false_optionsId_0_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_Register_vue__["a" /* render */],
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_e24368cc_hasScoped_false_optionsId_0_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_Register_vue__["b" /* staticRenderFns */],
  __vue_template_functional__,
  __vue_styles__,
  __vue_scopeId__,
  __vue_module_identifier__
...
var render = function() {
  ...
  return _c("div", { staticClass: "row justify-content-center" }, [
    _vm.divload
      ? _c("div", { staticClass: "preloader-background" }, [_vm._m(0)])
      : _vm._e(),
    _vm._v(" "),
    _c("div", { staticClass: "col-md-6 col-lg-4 login-box" }, [
      ...
      _vm.success
        ? _c("div", { staticClass: "alert alert-success" }, [
            ...
            _c("span", [
              _vm._v(
                "Please verify also your email to confirm your account in Vacancity"
              )
            ])
          ])
        : _vm._e(),
        ...
        ? _c(
            ...
            [
              ...
              _c(
                "div",
                {
                  staticClass: "form-group  input-field",
                ...
                [
                  ...
                  _vm.error && _vm.errors.name
                    ? _c("small", { staticClass: "help-block text-danger" }, [
              ...
              _c(
                ...
                [
                  _c("label", { attrs: { for: "password" } }, [
                    _vm._v("Password (6 or more characters)")
                  ]),
                  _vm._v(" "),
                  _c("input", {
                    directives: [
              ...
              _c("div", { staticClass: "text-center mb-2" }, [
                ...
                _c(
                  "small",
                  [
                    _vm._v("View our Privacy Policy and agreement "),
...
var staticRenderFns = [
  ...
  function() {
    ...
    var _c = _vm._self._c || _h
    return _c("div", {}, [
      _c("p", [_vm._v("Register and apply available jobs")]),
      _vm._v(" "),
      _c("hr")
    ])
  },
  function() {
    ...
    return _c(
      ...
      {
        staticClass:
          "btn-small waves-effect waves-light  blue darken-1 btn-block mb-1",
        attrs: { type: "submit" }
      },
      [
        _c("span", [_c("i", { staticClass: "fa fa-user-circle google-svg" })]),
        _vm._v(" Join now")
      ]
    )
  }
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-e24368cc", { render: render, staticRenderFns: staticRenderFns })
  }
}
...
/* unused harmony namespace reexport */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_01e7f602_hasScoped_false_optionsId_0_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_Login_vue__ = __webpack_require__(57);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__node_modules_vue_loader_lib_runtime_component_normalizer__ = __webpack_require__(1);
var disposed = false
/* script */
...
var Component = Object(__WEBPACK_IMPORTED_MODULE_2__node_modules_vue_loader_lib_runtime_component_normalizer__["a" /* default */])(
  ...
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_01e7f602_hasScoped_false_optionsId_0_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_Login_vue__["a" /* render */],
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_01e7f602_hasScoped_false_optionsId_0_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_Login_vue__["b" /* staticRenderFns */],
  __vue_template_functional__,
  __vue_styles__,
  __vue_scopeId__,
  __vue_module_identifier__
...
var render = function() {
  ...
  return _c("div", { staticClass: "row justify-content-center" }, [
    ...
    _c(
      "div",
      { staticClass: "col-md-6 col-lg-4 login-box" },
      [
        _vm._m(1),
        _vm._v(" "),
        _c("hr"),
        ...
        _c(
          ...
          {
            staticClass:
              "btn-small waves-effect waves-light red darken-1 white-text btn-block mb-1",
            attrs: { to: { name: "login" } }
          },
          [
            _c("span", [_c("i", { staticClass: "fa fa-google google-svg" })]),
            _vm._v("\n                      Use Google Account\n              ")
          ]
        ),
        _vm._v(" "),
        _c(
          ...
          {
            staticClass:
              "btn-small waves-effect waves-light  blue darken-4 white-text btn-block mb-1",
            on: {
              click: function($event) {
        ...
        _vm._v(" "),
        _c("div", { staticClass: "form-option" }, [_vm._v("or")]),
        _vm._v(" "),
        _vm.error && !_vm.success
          ? _c("div", { staticClass: "alert alert-danger" }, [
              _c("span", [
...
var staticRenderFns = [
  ...
  function() {
    ...
    var _h = _vm.$createElement
    var _c = _vm._self._c || _h
    return _c("div", {}, [_c("p", [_vm._v("Sign in to view jobs")])])
  },
  function() {
    var _vm = this
    var _h = _vm.$createElement
    var _c = _vm._self._c || _h
    return _c("span", [_c("i", { staticClass: "fa fa-facebook google-svg" })])
  },
  function() {
    var _vm = this
    var _h = _vm.$createElement
    ...
    return _c(
      ...
      [
        _c("span", [_c("i", { staticClass: "fa fa-lock google-svg" })]),
        _vm._v(" Sign in")
      ]
    )
  }
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-01e7f602", { render: render, staticRenderFns: staticRenderFns })
  }
}
...
/* unused harmony namespace reexport */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_22ef5402_hasScoped_false_optionsId_0_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_Profile_vue__ = __webpack_require__(59);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__node_modules_vue_loader_lib_runtime_component_normalizer__ = __webpack_require__(1);
var disposed = false
/* script */
...
var Component = Object(__WEBPACK_IMPORTED_MODULE_2__node_modules_vue_loader_lib_runtime_component_normalizer__["a" /* default */])(
  ...
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_22ef5402_hasScoped_false_optionsId_0_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_Profile_vue__["a" /* render */],
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_22ef5402_hasScoped_false_optionsId_0_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_Profile_vue__["b" /* staticRenderFns */],
  __vue_template_functional__,
  __vue_styles__,
  __vue_scopeId__,
  __vue_module_identifier__
...
var render = function() {
  ...
  return _c("div", {}, [
      ...
      _c("div", { staticClass: "col l8" }, [
        _c("div", { staticClass: "card" }, [
          _c("div", { staticClass: "card-content" }, [
              ...
              _c("div", {}, [
                ...
                _c("span", { staticClass: "float-right" }, [
                  _c(
                    ...
                    {
                      staticClass:
                        "btn-floating  waves-effect waves-light white darken-2 btn-small tooltipped",
                      attrs: {
                        "data-position": "bottom",
                        "data-tooltip": "Edit Profile"
                      },
                      on: { click: _vm.editInfoModal }
                    },
                    [
                ...
                _vm._v(" "),
                _c("div", { staticClass: "div-profile" }, [
                  _c("h3", { staticClass: "title-work" }, [
                    _c(
                      "a",
                      {
                      ...
                      [
                        _vm._v(
                          _vm._s(_vm.show_info.name) +
                            " " +
                            _vm._s(_vm.show_info.lastname)
                        )
                      ]
                    )
                  ]),
                  _vm._v(" "),
                  _c("h4", { staticClass: "work-info" }, [
                    _vm._v(
                      _vm._s(_vm.show_info.position) +
                        " at " +
                        _vm._s(_vm.show_info.company)
                    )
                  ])
                ])
              ]),
              _vm._v(" "),
              _c("span", { staticClass: "float-left navbar-nav" }, [
                _c("div", {}, [
                  _c("div", { staticClass: "nav-item dropdown" }, [
                    ...
                    _c(
                      "div",
                      {
                        staticClass: "dropdown-menu  collection user-dropdown",
                        attrs: { "aria-labelledby": "navbarDropdown" }
                      },
                      [
                        _c("div", {}, [
                          _c("a", { staticClass: "collection-item" }, [
                            _c(
                              ...
                              {
                                staticClass:
                                  "btn-floating  waves-effect waves-light blue darken-2 btn-small",
                                on: {
                                  click: function($event) {
                                    _vm.showModalWork("add")
                                  }
                                }
                              },
                              [
            ...
            _c("div", { staticClass: "divider" }),
            _vm._v(" "),
            _c("span", { staticClass: "md-2" }, [
              _vm._v(_vm._s(_vm.show_info.headline) + " ")
            ]),
            _vm._v(" "),
            _c("div", { staticClass: "divider" }),
            _vm._v(" "),
            _c(
              ...
              [
                ...
                _vm.divWork
                  ? _c("div", [
                      _c("h6", { staticClass: "text-center" }, [
                        _vm._v(
                          "No data recorded. Add some more work information"
                        )
                      ]),
                      _vm._v(" "),
                      _c("div", { staticClass: "divider" })
                ...
                _vm._l(_vm.works, function(work) {
                  return _c(
                    "div",
                    { key: work.work_id, staticClass: "div-work-main" },
                    [
                      _vm._m(2, true),
                      _vm._v(" "),
                      _c("span", { staticClass: "float-right" }, [
                        _c(
                          "button",
                          {
                            ...
                            attrs: {
                              "data-position": "bottom",
                              "data-tooltip": "Edit Work"
                            },
                            on: {
                              click: function($event) {
                                _vm.showModalWork(work)
                              }
                            }
                          },
                          [
                      ...
                      _c("div", { staticClass: "div-work" }, [
                        ...
                        _c("h4", { staticClass: "work-info" }, [
                          _vm._v(
                            _vm._s(work.from_month) +
                              " " +
                              _vm._s(work.from_year) +
                              " - "
                          ),
                          _c("span", [
                            _vm._v(
                              _vm._s(work.to_month) + " " + _vm._s(work.to_year)
                            )
                          ])
                        ]),
                        _vm._v(" "),
                        _c("div", { staticClass: "work-desc" }, [
                          _c("span", [_vm._v(_vm._s(work.description))])
                        ])
                      ])
                    ]
                  )
              ...
              [
                ...
                _vm.divEduc
                  ? _c("div", [
                      _c("h6", { staticClass: "text-center" }, [
                        _vm._v(
                          "No data recorded. Add some more education information"
                        )
                      ]),
                      _vm._v(" "),
                      _c("div", { staticClass: "divider" })
                ...
                _vm._l(_vm.educations, function(education) {
                  return _c(
                    "div",
                    { key: education.educ_id, staticClass: "div-work-main" },
                    [
                      _vm._m(3, true),
                      _vm._v(" "),
                      _c("span", { staticClass: "float-right" }, [
                      ...
                      _c("div", { staticClass: "div-work" }, [
                        ...
                        _c("h4", { staticClass: "work-info" }, [
                          _c("span", [
                            _vm._v(
                              _vm._s(education.from_year) +
                                " -  " +
                                _vm._s(education.to_year)
                            )
                          ])
                        ]),
                        _vm._v(" "),
                        _c("div", { staticClass: "work-desc" }, [
                          _c("span", [_vm._v(_vm._s(education.description))])
                        ])
                      ])
                    ]
                  )
    ...
    _vm._v(" "),
    _vm.divload
      ? _c("div", { staticClass: "preloader-background" }, [_vm._m(5)])
      : _vm._e(),
    _vm._v(" "),
    _c(
      "div",
      { staticClass: "modal modal-fixed-footer", attrs: { id: "modProfile" } },
      [
        _c(
          "form",
          {
          ...
          [
            _c("div", { staticClass: "modal-content" }, [
              _c("h5", { staticClass: "modal-header-cus" }, [
                _vm._v("Edit Info")
              ]),
              _vm._v(" "),
              _c("div", { staticClass: "divider" }),
                ...
                _c("div", { staticClass: "row" }, [
                  ...
                  _c("div", { staticClass: "col l6" }, [
                    _c("div", { staticClass: "form-group" }, [
                      ...
                      _c("input", {
                        ...
                        domProps: { value: _vm.user_info.lastname },
                        on: {
                          input: function($event) {
                            if ($event.target.composing) {
                              return
                          ...
                          directives: [
                            {
                              name: "model",
                              rawName: "v-model",
                              value: _vm.user_info.educ_id,
                              expression: "user_info.educ_id"
                            }
                          ],
                          staticClass: "form-control custom-input",
                          attrs: { name: "educ", required: "" },
                          on: {
                            change: function($event) {
                              var $$selectedVal = Array.prototype.filter
                                .call($event.target.options, function(o) {
                        ...
                        [
                          ...
                          _vm._l(_vm.educations, function(education) {
                            return _c(
                              "option",
                              {
                                key: education.educ_id,
                                domProps: { value: education.educ_id }
                              },
                              [
                                _vm._v(
                                  "\n                                                    " +
                  ...
                  _c("div", { staticClass: "col l12" }, [
                    _c("div", { staticClass: "form-group" }, [
                      ...
                      _vm._v(" "),
                      _c("img", { attrs: { src: "img/youtube.PNG", alt: "" } }),
                      _vm._v(" "),
                      _c("input", {
                        directives: [
                          {
    ...
    _c(
      "div",
      { staticClass: "modal modal-fixed-footer", attrs: { id: "modExpi" } },
      [
        _c(
          "form",
          {
                      ...
                      _c("input", {
                        ...
                        on: {
                          input: function($event) {
                            ...
                            _vm.$set(_vm.work, "company", $event.target.value)
                          }
                        }
                      })
                    ])
                      ...
                      _c("input", {
                        ...
                        on: {
                          input: function($event) {
                            ...
                            _vm.$set(_vm.work, "location", $event.target.value)
                          }
                        }
                      })
                    ])
            ...
            _c("div", { staticClass: "modal-footer" }, [
              _vm.edit
                ? _c(
                    ...
                    {
                      staticClass:
                        "waves-effect waves-green btn-flat black-text",
                      on: {
                        click: function($event) {
                          _vm.deleteWork(_vm.work.work_id)
                        }
                      }
                    },
                    [_vm._v("Delete")]
    ...
    _c(
      "div",
      { staticClass: "modal modal-fixed-footer", attrs: { id: "modEduc" } },
      [
        _c(
          "form",
          {
                  ...
                  _c("div", { staticClass: "col l12" }, [
                    _c("div", { staticClass: "form-group" }, [
                      ...
                      _c("input", {
                        directives: [
                          {
                            name: "model",
                            rawName: "v-model",
                            value: _vm.education.school_name,
                            expression: "education.school_name"
                          }
                        ],
                        staticClass: "form-control custom-input",
                        attrs: {
                        ...
                        domProps: { value: _vm.education.school_name },
                        on: {
                          input: function($event) {
                            if ($event.target.composing) {
                              return
                  ...
                  _c("div", { staticClass: "col l12" }, [
                    _c("div", { staticClass: "form-group" }, [
                      ...
                      _c("input", {
                        ...
                        domProps: { value: _vm.education.degree },
                        on: {
                          input: function($event) {
                            if ($event.target.composing) {
                              return
                  ...
                  _c("div", { staticClass: "col l12" }, [
                    _c("div", { staticClass: "form-group" }, [
                      ...
                      _c("input", {
                        directives: [
                          {
                            name: "model",
                            rawName: "v-model",
                            value: _vm.education.field_of_study,
                            expression: "education.field_of_study"
                          }
                        ],
                        staticClass: "form-control custom-input",
                        attrs: {
                        ...
                        domProps: { value: _vm.education.field_of_study },
                        on: {
                          input: function($event) {
                            if ($event.target.composing) {
                              return
              ...
              _vm.edit
                ? _c(
                    "div",
                    {
                      ...
                      on: {
                        click: function($event) {
                          _vm.deleteEduc(_vm.education.educ_id)
                        }
                      }
                    },
                    [_vm._v("Delete")]
...
var staticRenderFns = [
  function() {
    ...
    return _c("div", {}, [
      _c("img", {
        staticClass: "img-profile img-bordered-sm",
        attrs: {
  ...
  function() {
    ...
    return _c(
      "a",
      {
        staticClass: "nav-item nav-link mr-md-2",
        attrs: {
          href: "#",
          id: "bd-versions",
          "data-toggle": "dropdown",
      ...
      [
        _c("span", [
          _c(
            ...
            {
              staticClass:
                "btn waves-effect waves-light blue darken-2 btn-small tooltipped",
              attrs: {
                "data-position": "right",
                "data-tooltip": "Click to add credentials"
              }
            },
            [
  ...
  function() {
    ...
    var _h = _vm.$createElement
    var _c = _vm._self._c || _h
    return _c("div", { staticClass: "work-logo" }, [
      _c("i", { staticClass: "material-icons medium blue-text" }, [
        _vm._v("work")
      ])
    ])
  },
  function() {
    ...
    var _c = _vm._self._c || _h
    return _c("div", { staticClass: "work-logo" }, [
      _c("i", { staticClass: "material-icons medium grey-text" }, [
        _vm._v("school")
      ])
    ])
  },
  function() {
    ...
    var _h = _vm.$createElement
    var _c = _vm._self._c || _h
    return _c("p", { staticClass: "collection-item active" }, [
      _c("span", [
        _c(
          "button",
          {
            staticClass:
              "btn-floating  waves-effect waves-light blue darken-2 btn-small modal-trigger tooltipped"
          },
          [
            _c("i", { staticClass: "material-icons " }, [
              _vm._v("personal_video")
            ])
          ]
        )
      ]),
      _vm._v(" "),
      _c("span", [_vm._v("Personal Introduction")])
    ])
  },
  function() {
    var _vm = this
  ...
  function() {
    ...
    return _c("div", { staticClass: "modal-footer" }, [
      _c(
        "button",
        {
          staticClass: "waves-effect waves-green btn-flat blue white-text ",
          attrs: { type: "submit" }
        },
        [_vm._v("Save")]
      ),
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-22ef5402", { render: render, staticRenderFns: staticRenderFns })
  }
}
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__node_modules_vue_loader_lib_template_compiler_index_id_data_v_ade8bc7a_hasScoped_false_optionsId_0_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_Messages_vue__ = __webpack_require__(61);
...
var Component = Object(__WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_runtime_component_normalizer__["a" /* default */])(
  __vue_script__,
  __WEBPACK_IMPORTED_MODULE_0__node_modules_vue_loader_lib_template_compiler_index_id_data_v_ade8bc7a_hasScoped_false_optionsId_0_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_Messages_vue__["a" /* render */],
  __WEBPACK_IMPORTED_MODULE_0__node_modules_vue_loader_lib_template_compiler_index_id_data_v_ade8bc7a_hasScoped_false_optionsId_0_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_Messages_vue__["b" /* staticRenderFns */],
  __vue_template_functional__,
  __vue_styles__,
  __vue_scopeId__,
  __vue_module_identifier__
...
var staticRenderFns = [
  function() {
    ...
    var _h = _vm.$createElement
    var _c = _vm._self._c || _h
    return _c("div", { staticClass: "msg-divsearch" }, [
      _c("input", {
        staticClass: "form-control custom-input msg-search",
  ...
  function() {
    ...
    var _h = _vm.$createElement
    var _c = _vm._self._c || _h
    return _c("div", { staticClass: "user-block msg-main" }, [
      _c("div", { staticClass: "msg-prof-img" }, [
        _c("img", {
          staticClass: "circle img-bordered-sm msg-prof-img_main",
          attrs: {
            src:
              "https://adminlte.io/themes/AdminLTE/dist/img/user1-128x128.jpg",
            alt: "user image"
      ...
      _c("div", { staticClass: "msg-content" }, [
        _c("span", { staticClass: "username" }, [
          _c("a", { attrs: { href: "#" } }, [_vm._v("Jonathan Burke Jr.")]),
          _vm._v(" "),
          _c("span", { staticClass: "msg-time pull-right" }, [
            _vm._v(" June 14")
          ])
        ]),
        _vm._v(" "),
        _c("span", { staticClass: "msg-text" }, [
          _vm._v(
            "\n                            asdasd\n                        "
          )
        ])
  ...
  function() {
    ...
    var _h = _vm.$createElement
    var _c = _vm._self._c || _h
    return _c("div", { staticClass: "col l6" }, [
      _c("div", { staticClass: "card" })
    ])
  },
  function() {
    ...
    var _h = _vm.$createElement
    var _c = _vm._self._c || _h
    return _c("div", { staticClass: "col l3" }, [
      _c("div", { staticClass: "card" })
    ])
  }
]
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-ade8bc7a", { render: render, staticRenderFns: staticRenderFns })
  }
}
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__node_modules_vue_loader_lib_template_compiler_index_id_data_v_7c067121_hasScoped_false_optionsId_0_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_Error_vue__ = __webpack_require__(63);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_runtime_component_normalizer__ = __webpack_require__(1);
var disposed = false
/* script */
var __vue_script__ = null
...
var Component = Object(__WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_runtime_component_normalizer__["a" /* default */])(
  __vue_script__,
  __WEBPACK_IMPORTED_MODULE_0__node_modules_vue_loader_lib_template_compiler_index_id_data_v_7c067121_hasScoped_false_optionsId_0_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_Error_vue__["a" /* render */],
  __WEBPACK_IMPORTED_MODULE_0__node_modules_vue_loader_lib_template_compiler_index_id_data_v_7c067121_hasScoped_false_optionsId_0_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_Error_vue__["b" /* staticRenderFns */],
  __vue_template_functional__,
  __vue_styles__,
  __vue_scopeId__,
  __vue_module_identifier__
)
Component.options.__file = "resources\\assets\\js\\components\\Error.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-7c067121", Component.options)
  } else {
    hotAPI.reload("data-v-7c067121", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
var staticRenderFns = [
  function() {
    ...
    return _c("div", [
      ...
      _vm._v(" "),
      _c("div", [
        _c("div", { staticClass: "row docs-premium-template" }, [
                    ...
                    _c(
                      ...
                      [
                        _c("img", {
                          ...
                          attrs: {
                            src:
                              "https://themequarry.com/storage/images/approved/ASFEDA95_v2.1_5a0eaa448e2d5.png",
                            alt: "Ample Admin"
                          }
                        })
                      ]
                    ...
                    _c("div", { staticClass: "clearfix" }, [
                      _c("p", { staticClass: "pull-right" }, [
                        _c(
                          ...
                          {
                            staticClass:
                              "btn btn-success btn-sm ad-click-event",
                            attrs: {
                              href:
                                "https://themequarry.com/theme/ample-admin-the-ultimate-dashboard-template-ASFEDA95"
                            }
                      ...
                      _c("h4", { staticStyle: { "margin-top": "0" } }, [
                        _vm._v("Ample Admin ─ $24")
                      ]),
                      _vm._v(" "),
                      _c("p", [_vm._v("Admin + Frontend Template")]),
                      _vm._v(" "),
                      _c("p", { staticStyle: { "margin-bottom": "0" } }, [
                        _c("i", {
                          staticClass: "fa fa-shopping-cart margin-r5"
                        }),
                        _vm._v(
                          " 100+ purchases\r\n                                    "
                        )
                ...
                _c("div", { staticClass: "media" }, [
                  _c("div", { staticClass: "media-left" }, [
                    _c(
                      "a",
                      {
                        ...
                        attrs: {
                          href:
                            "https://themequarry.com/theme/appzia-responsive-admin-dashboard-ASFEDAAB"
                        }
                      },
                      [
                        _c("img", {
                          ...
                          attrs: {
                            src:
                              "https://themequarry.com/storage/images/approved/ASFEDAAB_v1.0.0_5992c3326c307.png",
                            alt: "Appzia"
                          }
                        })
                      ]
                  ...
                  _c("div", { staticClass: "media-body" }, [
                    _c("div", { staticClass: "clearfix" }, [
                      ...
                      _vm._v(" "),
                      _c("p", [_vm._v("Responsive Admin Dashboard")]),
                      _vm._v(" "),
                      _c("p", { staticStyle: { "margin-bottom": "0" } }, [
                        _c("i", {
                          staticClass: "fa fa-shopping-cart margin-r5"
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-7c067121", { render: render, staticRenderFns: staticRenderFns })
  }
}
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_cacheDirectory_true_presets_env_modules_false_targets_browsers_2_uglify_true_plugins_transform_object_rest_spread_transform_runtime_polyfill_false_helpers_false_node_modules_vue_loader_lib_selector_type_script_index_0_Job_Post_vue__ = __webpack_require__(82);
/* unused harmony namespace reexport */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_6ddc4d79_hasScoped_false_optionsId_0_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_Job_Post_vue__ = __webpack_require__(65);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__node_modules_vue_loader_lib_runtime_component_normalizer__ = __webpack_require__(1);
var disposed = false
/* script */
...
var Component = Object(__WEBPACK_IMPORTED_MODULE_2__node_modules_vue_loader_lib_runtime_component_normalizer__["a" /* default */])(
  __WEBPACK_IMPORTED_MODULE_0__babel_loader_cacheDirectory_true_presets_env_modules_false_targets_browsers_2_uglify_true_plugins_transform_object_rest_spread_transform_runtime_polyfill_false_helpers_false_node_modules_vue_loader_lib_selector_type_script_index_0_Job_Post_vue__["a" /* default */],
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_6ddc4d79_hasScoped_false_optionsId_0_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_Job_Post_vue__["a" /* render */],
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_6ddc4d79_hasScoped_false_optionsId_0_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_Job_Post_vue__["b" /* staticRenderFns */],
  __vue_template_functional__,
  __vue_styles__,
  __vue_scopeId__,
  __vue_module_identifier__
)
Component.options.__file = "resources\\assets\\js\\components\\Job_Post.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-6ddc4d79", Component.options)
  } else {
    hotAPI.reload("data-v-6ddc4d79", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
var render = function() {
  ...
  return _c("div", { staticClass: "row" }, [
    _c("div", { staticClass: "card col s12" }, [
      _c("div", { staticClass: "container-fluid pad-2" }, [
        _vm._m(0),
        _vm._v(" "),
        _c("div", { staticClass: "row" }, [
          _c(
            "form",
            {
              on: {
                submit: function($event) {
                  $event.preventDefault()
                  return _vm.SaveJob($event)
                }
              }
            },
            [
              _c("div", { staticClass: "col s12 l6" }, [
                _c("div", { staticClass: " form-group col s12" }, [
                  _c("label", { attrs: { for: "company" } }, [
                    _vm._v("Company")
                  ]),
                  _vm._v(" "),
                  _c("input", {
                    ...
                    on: {
                      input: function($event) {
                        ...
                        _vm.$set(_vm.job, "company", $event.target.value)
                      }
                    }
                  })
                ]),
                ...
                _c("div", { staticClass: " form-group col s12" }, [
                  ...
                  _c("input", {
                    ...
                    attrs: {
                      type: "text",
                      placeholder: "Postion Desired",
                      required: ""
                    },
                    domProps: { value: _vm.job.position },
                    on: {
                      input: function($event) {
                        if ($event.target.composing) {
                          return
                        }
                        _vm.$set(_vm.job, "position", $event.target.value)
                      }
                    }
                  })
                ]),
                ...
                _c("div", { staticClass: " form-group col s12" }, [
                  ...
                  _c("input", {
                    directives: [
                      {
                        name: "model",
                        rawName: "v-model",
                        value: _vm.job.company_industry,
                        expression: "job.company_industry"
                      }
                    ],
                    staticClass: "form-control custom-input",
                    attrs: {
                    ...
                    domProps: { value: _vm.job.company_industry },
                    on: {
                      input: function($event) {
                        if ($event.target.composing) {
                          return
                ...
                _c("div", { staticClass: " form-group col s12" }, [
                  ...
                  _c("input", {
                    directives: [
                      {
                        name: "model",
                        rawName: "v-model",
                        value: _vm.job.job_function,
                        expression: "job.job_function"
                      }
                    ],
                    staticClass: "form-control custom-input",
                    attrs: {
                    ...
                    domProps: { value: _vm.job.job_function },
                    on: {
                      input: function($event) {
                        if ($event.target.composing) {
                          return
                        }
                        _vm.$set(_vm.job, "job_function", $event.target.value)
                      }
                    }
                  })
                ]),
              ...
              _vm._v(" "),
              _c("div", { staticClass: "col s12 l6" }, [
                _c("div", { staticClass: " form-group col s6" }, [
                  _c("label", { attrs: { for: "Location" } }, [
                  ...
                  _c(
                      ...
                      directives: [
                        {
                          name: "model",
                          rawName: "v-model",
                          value: _vm.job.employment_type,
                          expression: "job.employment_type"
                        }
                      ],
                      staticClass: "form-control custom-input",
                      attrs: { name: "", id: "" },
                    ...
                    [
                      ...
                      _vm._v(" "),
                      _c("option", [_vm._v("Contract")]),
                      _vm._v(" "),
                      _c("option", [_vm._v("Temporary")]),
                      _vm._v(" "),
                ...
                _c("div", { staticClass: " form-group col s6" }, [
                  ...
                  _c(
                      ...
                      directives: [
                        {
                          name: "model",
                          rawName: "v-model",
                          value: _vm.job.senority_level,
                          expression: "job.senority_level"
                        }
                      ],
                      staticClass: "form-control custom-input",
                      attrs: { name: "", id: "" },
                    ...
                    [
                      ...
                      _c("option", [_vm._v("Internship")]),
                      _vm._v(" "),
                      _c("option", [_vm._v("Entry level")]),
                      _vm._v(" "),
                      _c("option", [_vm._v("Associate")]),
                      _vm._v(" "),
                      _c("option", [_vm._v("Mid-Senior level")]),
                      _vm._v(" "),
                      _c("option", [_vm._v("Director")]),
                      _vm._v(" "),
                      _c("option", { attrs: { selected: "" } }, [
                        _vm._v("Executive")
                      ])
                      ...
                      directives: [
                        {
                          name: "model",
                          rawName: "v-model",
                          value: _vm.job.degree,
                          expression: "job.degree"
                        }
                      ],
                      staticClass: "form-control custom-input",
                ...
                _c("div", { staticClass: " form-group col s6" }, [
                  ...
                  _c("input", {
                    directives: [
                      {
                        name: "model",
                        rawName: "v-model",
                        value: _vm.job.expi_level,
                        expression: "job.expi_level"
                      }
                    ],
                    staticClass: "form-control custom-input",
                    attrs: {
                    ...
                    domProps: { value: _vm.job.expi_level },
                    on: {
                      input: function($event) {
                        if ($event.target.composing) {
                          return
                        }
                        _vm.$set(_vm.job, "expi_level", $event.target.value)
                      }
                    }
                  })
                ]),
                ...
                _c("div", { staticClass: " form-group col s12 " }, [
                  ...
                  _c("textarea", {
                    ...
                    staticClass: "form-control",
                    attrs: { name: "description", rows: "6", required: "" },
                    domProps: { value: _vm.job.job_description },
                    on: {
                      input: function($event) {
                        if ($event.target.composing) {
                          return
    ...
    _vm._v(" "),
    _vm.divload
      ? _c("div", { staticClass: "preloader-background" }, [_vm._m(2)])
      : _vm._e()
  ])
}
var staticRenderFns = [
  function() {
    ...
    return _c("div", { staticClass: "text-center" }, [
      _c("span", { staticClass: "info-title text-center" }, [
        _vm._v("Post a job: create a oppurtunity to the people")
      ])
    ])
  },
  function() {
    ...
    return _c("div", { staticClass: "col s12" }, [
      _c("div", { staticClass: "nav-item dropdown float-left" }, [
        _c(
          "a",
          {
        ...
        _c(
          ...
          [
            _c("div", {}, [
              _c("a", { staticClass: "collection-item" }, [
                _c("div", { staticClass: "btn-job-setting" }, [
                  _c(
                    "button",
                    {
                      staticClass:
                ...
                _vm._v(" "),
                _c("div", [
                  _c("span", [_vm._v(" Public post")]),
                  _vm._v(" "),
                  _c("br"),
                  _vm._v(" "),
                  _c("small", [_vm._v("Everyone will see this posting")])
                ])
              ]),
              _vm._v(" "),
              _c("a", { staticClass: "collection-item" }, [
                ...
                _vm._v(" "),
                _c("div", [
                  _c("span", [_vm._v(" Private post")]),
                  _vm._v(" "),
                  _c("br"),
                  _vm._v(" "),
                  _c("small", [
                    _vm._v("Only your network will see this posting")
                  ])
                ])
              ])
            ])
      ...
      _c(
        ...
        {
          staticClass:
            "float-right btn waves-effect waves-light light-blue darken-4"
        },
        [
          _vm._v(
            "\n                                    Proceed\n                                "
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-6ddc4d79", { render: render, staticRenderFns: staticRenderFns })
  }
}
...
var Auth = __webpack_require__(67)();
...
var __utils  = __webpack_require__(68),
    __token  = __webpack_require__(69),
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__node_modules_vue_loader_lib_template_compiler_index_id_data_v_cd7fb372_hasScoped_false_optionsId_0_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_Navbar_vue__ = __webpack_require__(74);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_runtime_component_normalizer__ = __webpack_require__(1);
var disposed = false
/* script */
var __vue_script__ = null
...
var Component = Object(__WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_runtime_component_normalizer__["a" /* default */])(
  __vue_script__,
  __WEBPACK_IMPORTED_MODULE_0__node_modules_vue_loader_lib_template_compiler_index_id_data_v_cd7fb372_hasScoped_false_optionsId_0_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_Navbar_vue__["a" /* render */],
  __WEBPACK_IMPORTED_MODULE_0__node_modules_vue_loader_lib_template_compiler_index_id_data_v_cd7fb372_hasScoped_false_optionsId_0_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_Navbar_vue__["b" /* staticRenderFns */],
  __vue_template_functional__,
  __vue_styles__,
  __vue_scopeId__,
  __vue_module_identifier__
      ...
      [
        ...
        _c("li", { staticClass: "nav-item dropdown" }, [
          _c(
            ...
            [_c("small", [_vm._v("Patrick Delos Santos")])]
          ),
          _vm._v(" "),
          _c(
            "div",
        ...
        _c("li", { staticClass: "nav-item" }, [
          _c("img", {
            ...
            attrs: {
              src:
                "https://mug0.assets-yammer.com/mugshot/images/48x48/2fZzmGR7SxJljNWNGg8vqlhd8hX1B9rc",
              alt: ""
            }
          })
        ])
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-cd7fb372", { render: render, staticRenderFns: staticRenderFns })
  }
}
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__node_modules_vue_loader_lib_template_compiler_index_id_data_v_00467796_hasScoped_false_optionsId_0_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_Sidebar_vue__ = __webpack_require__(76);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_runtime_component_normalizer__ = __webpack_require__(1);
var disposed = false
/* script */
var __vue_script__ = null
...
var Component = Object(__WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_runtime_component_normalizer__["a" /* default */])(
  __vue_script__,
  __WEBPACK_IMPORTED_MODULE_0__node_modules_vue_loader_lib_template_compiler_index_id_data_v_00467796_hasScoped_false_optionsId_0_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_Sidebar_vue__["a" /* render */],
  __WEBPACK_IMPORTED_MODULE_0__node_modules_vue_loader_lib_template_compiler_index_id_data_v_00467796_hasScoped_false_optionsId_0_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_Sidebar_vue__["b" /* staticRenderFns */],
  __vue_template_functional__,
  __vue_styles__,
  __vue_scopeId__,
  __vue_module_identifier__
...
var staticRenderFns = [
  function() {
    ...
    return _c("main", { staticClass: "container", attrs: { role: "main" } }, [
      _c("div", [
        _c("h3", { staticClass: "lead" }, [_vm._v("Basic Informations")])
      ])
    ])
  }
]
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-00467796", { render: render, staticRenderFns: staticRenderFns })
  }
}
...
/* harmony default export */ __webpack_exports__["a"] = ({
    ...
    methods: {
        SaveJob: function SaveJob() {
            ...
            app.divload = true;
            if (this.edit === false) {
                this.$http.post('/job/', this.job).then(function (response) {
                    app.divload = false;
